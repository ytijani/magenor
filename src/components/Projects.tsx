                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-20">
                        <div>
                            ...
                            >
                                Nos chantiers de <br />
                                <span className="text-primary/15">références historiques.</span>
                            </motion.h2>
                        </div>
                        <motion.button
                            initial={{ opacity: 0 }}
                            ...
                            className="group flex items-center gap-3 text-primary font-bold text-[13px] tracking-tight uppercase pb-1 border-b-2 border-primary/5 hover:border-primary transition-all duration-300"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        {projects.map((project, index) => (
                            ...
                            >
                                <div className="relative aspect-[16/10] overflow-hidden rounded-2xl mb-6 bg-primary">
                                    <div
                                ...
                                <h3 className="text-xl md:text-2xl font-bold text-primary font-display tracking-tight group-hover:text-primary/70 transition-colors duration-300">
                                    {project.title}
                                </h3>
                            </motion.div>
                        ))}
